...
export default class OptTable extends Component{
 ...
 retrivePosts(){
  axios.get("http://localhost:8000/optdetails").then(res =>{
   if(res.data.success){
     this.setState({
 ...
 onDelete = (id) =>{
  ...
  axios.delete(`http://localhost:8000/optdetails/delete/${id}`).then((res) =>{
    ...
    return (
      ...
      <div className="container">
        ...
        <div className="raw">
              ...
              <h1 style={{marginLeft: "30%"}}>ALL Optional delivery details</h1>
              </div>
              <div class="alg"> 
              <div className="col-lg-9 mt-2 mb-2">
                <input 
